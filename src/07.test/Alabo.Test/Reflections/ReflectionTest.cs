...
using Xunit;
using ZKCloud.App.Core.Common.Domain.CallBacks;
using ZKCloud.App.Core.Finance.Domain.CallBacks;
using ZKCloud.App.Core.User.Domain.Callbacks;
using ZKCloud.App.Core.User.Domain.Entities;
using ZKCloud.Domains.Entities.Core;
...
namespace ZKCloud.Test.Helpers
{
    ...
    ///     测试反射操作
    /// </summary>
    public class ReflectionTest : CoreTest
    {
        /// <summary>
        ///     初始化测试
        /// </summary>
        ...
        [InlineData(typeof(WebSiteConfig))]
        [InlineData(typeof(UserTypeConfig))]
        public void AutoConfigTest(Type type)
        {
        ...
        public void TestGetTopBaseType()
        {
            ...
            Assert.Contains("ZKCloud.Web.Mvc.ViewModel.BaseViewModel", Reflection.GetTopBaseType<User>().FullName);
            Assert.Contains("ZKCloud.Web.Mvc.ViewModel.BaseViewModel",
                Reflection.GetTopBaseType<DomainBase<User>>().FullName);
            Assert.Contains("ZKCloud.Domains.Entities.Core.IEntity", Reflection.GetTopBaseType<IEntity>().FullName);
        }
