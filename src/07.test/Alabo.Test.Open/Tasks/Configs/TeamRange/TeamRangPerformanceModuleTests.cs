...
namespace Alabo.Test.Open.Tasks.Configs.TeamRange
{
    ...
    /// </summary>
    public class TeamRangPerformanceModuleTests : BaseShareTest
    {
        public TeamRangPerformanceModuleTests()
        {
            RegModuleConfigId = 316;
            ShopModuleConfigId = 317;
            ModuleType = typeof(TeamRangPerformanceModule);
            ConfigType = typeof(TeamRangPerformanceConfig);
        }
