...
namespace Alabo.Test.Generation
{
    ...
    ///     代码生成
    /// </summary>
    public class StartupTest : CoreTest
    {
        /// <summary>
        ///     生成单个服务的方法
        /// </summary>
        /// <param name="type"></param>
        //[InlineData(typeof(IRewardService))]
        //[InlineData(typeof(IPostRoleOldService))]
        // [InlineData(data: typeof(IAutoConfigService))]
        [InlineData(typeof(ILightAppService))]
        [Theory]
