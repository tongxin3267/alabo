...
namespace Alabo.Test.Core.AutoData.Domain.Services
{
    ...
    {
        private readonly string testTableName = "NEG_T1";
        ...
        {
            var id = ObjectId.Parse("5d1324ba0e630724ca16dd62");
        ...
        {
            var ConnectString =
                "mongodb://zkcloud:Cu6nJEpjxAjgi30lYxDuFu2JqCPqOfuSZj5BFPAM@183.60.143.29:30899/?connectTimeoutMS=30000&authMechanism=SCRAM-SHA-1";
            ...
            var rsList2 = Client.GetDatabase("v12_qnn").GetCollection<dynamic>("NEG_T1")
                .Find(Builders<dynamic>.Filter.Gt("Age", 12345)).ToList();
            //var rsList3 = Client.GetDatabase("v12_qnn").GetCollection<dynamic>("NEG_T1").Find(Builders<dynamic>.Filter.Eq("Age", "12345")).ToList();

            var filter1 = Builders<dynamic>.Filter.Eq("_id", "5d156dcf0e630724ca1d6354".ToObjectId()) |
                          Builders<dynamic>.Filter.Eq("_id", "5d156e0e0e630724ca1d97c7".ToObjectId());
            ...
            var rsList3 = Client.GetDatabase("v12_qnn").GetCollection<dynamic>("NEG_T1")
                .Find(Builders<dynamic>.Filter.Eq("_id", "5d156dcf0e630724ca1d6354".ToObjectId()) |
                      Builders<dynamic>.Filter.Eq("_id", "5d156e0e0e630724ca1d97c7".ToObjectId())).ToList();
            ...
            var rsList6 = Client.GetDatabase("v12_qnn").GetCollection<dynamic>("NEG_T1")
                .Find((Builders<dynamic>.Filter.Eq("Age", 12345) & Builders<dynamic>.Filter.Gte("UserId", 4)) |
                      Builders<dynamic>.Filter.Gte("_id", "5d156dcf0e630724ca1d6354")).ToList();
