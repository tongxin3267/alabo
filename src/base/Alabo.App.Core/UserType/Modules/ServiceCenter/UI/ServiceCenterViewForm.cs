...
namespace Alabo.App.Core.UserType.Modules.ServiceCenter {
    ...
    public class ServiceCenterViewForm : UIBase, IAutoForm {
        ...
        public AutoForm GetView(object id, AutoBaseModel autoModel) {
            var serviceCenterId = ToId<long>(id);
            var serviceCenterView = Resolve<IServiceCenterService>().GetView(serviceCenterId);
            var model = AutoMapping.SetValue<ServiceCenterViewForm>(serviceCenterView);
            return ToAutoForm(model);
        }

        public ServiceResult Save(object model, AutoBaseModel autoModel) {
            var serviceCenterView = AutoMapping.SetValue<ServiceCenterView>(model);
            var result = Resolve<IServiceCenterService>().AddOrUpdate(serviceCenterView);
            return result;
        }
    }
}