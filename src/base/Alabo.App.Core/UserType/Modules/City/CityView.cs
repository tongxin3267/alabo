...
namespace Alabo.App.Core.UserType.Modules.City {
    ...
    [ClassProperty(Name = "城市合伙人", Icon = "fa fa-puzzle-piece", Description = "城市合伙人",
        SideBarType = SideBarType.CitySideBar,
        GroupName = "基本信息,高级选项")]
    public class CityView : UIBase, IAutoTable<CityView> {
        ...
        public IEnumerable<ViewLink> ViewLinks() {
            ...
            var cityUserType = userTypes?.First(r => r.Id == UserTypeEnum.City.GetFieldId());
            var quickLinks = new List<ViewLink>
            {
                new ViewLink($"{cityUserType?.Name}添加", "/Admin/Basic/Edit?Service=ICityService&View=GetView", Icons.Add,
                    LinkType.TableQuickLink),
                new ViewLink("编辑", "/Admin/Basic/Edit?Service=ICityService&View=GetView&Id=[[Id]]", Icons.Edit,
                    LinkType.ColumnLink),
                new ViewLink("删除", "/Admin/Basic/Delete?Service=ICityService&Method=Delete&Id=[[Id]]", Icons.Delete,
                    LinkType.ColumnLinkDelete),
                new ViewLink($"{cityUserType?.Name}管理",
                    "/Admin/Basic/Delete?Service=ICityService&Method=Delete&Id=[[Id]]", Icons.List,
        ...
        public PageResult<CityView> PageTable(object query, AutoBaseModel autoModel) {
            var list = Resolve<ICityService>().GetPageList(query);
