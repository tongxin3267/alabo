...
namespace Alabo.App.Core.UserType.Modules.County {
    ...
    [ClassProperty(Name = "区县合伙人", Icon = "fa fa-puzzle-piece", Description = "区县合伙人", ListApi = "Api/AdminBasic/List?Service=ICountyService&&Method=GetPageList",
        SideBarType = SideBarType.CountySideBar, PostApi = "Api/AdminBasic/List?Service=ICountyService&&Method=GetPageList",
        GroupName = "基本信息,高级选项")]
    public class CountyViewForm : UIBase, IAutoForm {
        ...
        public AutoForm GetView(object id, AutoBaseModel autoModel) {
            var countyId = ToId<long>(id);
            var countyView = Resolve<ICountyService>().GetView(countyId);
            var model = AutoMapping.SetValue<CountyViewForm>(countyView);
            return ToAutoForm(model);
        }

        public ServiceResult Save(object model, AutoBaseModel autoModel) {
            var countyView = AutoMapping.SetValue<CountyView>(model);
            var result = Resolve<ICountyService>().AddOrUpdate(countyView);
            return result;
        }
    }
}