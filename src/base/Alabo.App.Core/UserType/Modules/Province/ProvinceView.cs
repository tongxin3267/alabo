...
namespace Alabo.App.Core.UserType.Modules.Province {
    ...
    [ClassProperty(Name = "省合伙人", Icon = "fa fa-puzzle-piece", Description = "省合伙人", PostApi = "Api/AdminBasic/List?Service=IProvinceService",
        SideBarType = SideBarType.ProvinceSideBar, ListApi = "Api/AdminBasic/List?Service=IProvinceService",
        GroupName = "基本信息,高级选项")]
    public class ProvinceView : UIBase, IAutoTable<ProvinceView> {
        ...
        /// </summary>
        [Display(Name = "用户类型")]
        public Guid UserTypeId { get; set; } = Guid.Parse("71be65e6-3a64-414d-972e-1a3d4a365101");
        ...
        [Field(ControlsType = ControlsType.TextBox, GroupTabId = 1, Width = "180", ListShow = true, IsMain = true,
            SortOrder = 0, Link = "/Admin/Basic/Edit?Service=IProvinceService&View=GetView&Id=[[Id]]")]
        ...
        [Display(Name = "所属省份")]
        [Required]
        [Field(ControlsType = ControlsType.ProvinceDropList, TableDispalyStyle = TableDispalyStyle.Code, GroupTabId = 1,
        ...
        ///     城市名字的显示名称
        /// </summary>
        [Field(ListShow = true, EditShow = false, Width = "160", SortOrder = 4)]
        [Display(Name = "所属城市")]
        ...
        [Field(ControlsType = ControlsType.RadioButton,
            DataSource = "Alabo.App.Core.UserType.Modules.Province.ProvinceGradeConfig", GroupTabId = 1,
            Width = "180",
        ...
        public IEnumerable<ViewLink> ViewLinks() {
            ...
            var provinceId = UserTypeEnum.Province.GetFieldId();
            var cityUserType = userTypes.FirstOrDefault(r => r.Id == provinceId);
            var quickLinks = new List<ViewLink>
            {
                new ViewLink("省合伙人添加", "/Admin/Basic/Edit?Service=IProvinceService&View=GetView",
                    Icons.Add, LinkType.TableQuickLink),
                new ViewLink("编辑", "/Admin/Basic/Edit?Service=IProvinceService&View=GetView&Id=[[Id]]", Icons.Edit,
                    LinkType.ColumnLink),
                new ViewLink("删除", "/Admin/Basic/Delete?Service=IProvinceService&Method=Delete&Id=[[Id]]", Icons.Delete,
                    LinkType.ColumnLinkDelete),
                new ViewLink("省合伙人管理",
                    "/Admin/Basic/Delete?Service=IProvinceService&Method=Delete&Id=[[Id]]", Icons.List,
        ...
        /// <returns></returns>
        public PageResult<ProvinceView> PageTable(object query, AutoBaseModel autoModel) {
            var list = Resolve<IProvinceService>().GetPageList(query);
        ...
        public List<TableAction> Actions() {
            ...
            {
                ToLinkAction("省合伙人", "/ProvinceView/list")
            };
            return list;
        }
    }
