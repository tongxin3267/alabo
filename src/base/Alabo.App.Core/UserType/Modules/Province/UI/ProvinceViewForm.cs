...
namespace Alabo.App.Core.UserType.Modules.Province {
    ...
    [ClassProperty(Name = "省合伙人", Icon = "fa fa-puzzle-piece", Description = "省合伙人", PostApi = "Api/AdminBasic/List?Service=IProvinceService",
        ...
        GroupName = "基本信息,高级选项")]
    public class ProvinceViewForm : UIBase, IAutoForm {
        ...
        public AutoForm GetView(object id, AutoBaseModel autoModel) {
            var provinceId = ToId<long>(id);
            var provinceView = Resolve<IProvinceService>().GetView(provinceId);
            var model = AutoMapping.SetValue<ProvinceViewForm>(provinceView);
            return ToAutoForm(model);
        }

        public ServiceResult Save(object model, AutoBaseModel autoModel) {
            var provinceView = AutoMapping.SetValue<ProvinceView>(model);
            var result = Resolve<IProvinceService>().AddOrUpdate(provinceView);
            return result;
        }
    }
}