...
namespace Alabo.App.Core.Finance.Domain.Entities {
    ...
    public class Bill : AggregateDefaultUserRoot<Bill> {
        ...
        /// </summary>
        [Display(Name = "货币类型")]
        [Field(ControlsType = ControlsType.DropdownList, IsShowAdvancedSerach = true, DataSourceType = typeof(MoneyTypeConfig), ListShow = false, EditShow = true, SortOrder = 10002, Width = "160")]
        ...
        /// </summary>
        [Display(Name = "资金流向")]
        [Field(ControlsType = ControlsType.DropdownList, ListShow = false, IsShowAdvancedSerach = true, EditShow = true, SortOrder = 10002, Width = "160")]
        ...
        /// </summary>
        [Display(Name = "金额")]
        [Field(ControlsType = ControlsType.NumberRang, ListShow = true, IsShowAdvancedSerach = true, EditShow = true, SortOrder = 10002, Width = "160")]
        ...
        [Field(ControlsType = ControlsType.NumberRang, ListShow = false, IsShowAdvancedSerach = true, EditShow = true, SortOrder = 10002, Width = "160")]
        ...
        /// </summary>
        [Display(Name = "序号")]
        [Field(ControlsType = ControlsType.Label, ListShow = false, IsShowAdvancedSerach = true, EditShow = true, SortOrder = 1, Width = "160")]
