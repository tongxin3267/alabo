...
namespace Alabo.App.Share.Tasks.Configs.TeamRange {
    ...
    /// </summary>
    [TaskModule("23B9A703-6B42-4005-800F-D1208905000d", "团队无级差绩效(二)", SortOrder = 999999, ConfigurationType = typeof(TeamRangPerformanceConfig4), IsSupportMultipleConfiguration = true,
         FenRunResultType = Core.Tasks.Domain.Enums.FenRunResultType.Price, IsSupportSetDistriRatio = false,
         Intro = "注意和团队无级差绩效(一)区别：自己拿自己的绩效，自己的绩效被自己拿！不同的等级之间绩效奖金会有所不同，比如总监A的绩效奖金为30%，经理B的绩效奖金为20%,业务员的绩效奖金为10%。那么经理可以拿到业务员的级差为10%，总监可以拿到经理的级差为10%，业务员的级差为20%",
