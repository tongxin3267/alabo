...
using ZKCloud.Webs.Controllers;

namespace ZKCloud.Webs.Controllers {
    /// <summary>
    /// Crud控制器
    /// </summary>
    ...
    public abstract class
        ...
        /// </summary>
        /// <param name="service">Crud服务</param>
        protected CrudControllerBase(ICrudService<TRequest, TQuery> service)
            : base(service) {
        }
    }
    ...
    public abstract class
        ...
        /// Crud服务
        /// </summary>
        private readonly ICrudService<TUpdateRequest, TCreateRequest, TUpdateRequest, TQuery> _service;

        /// <summary>
        /// 初始化Crud控制器
        /// </summary>
        /// <param name="service">Crud服务</param>
        protected CrudControllerBase(ICrudService<TUpdateRequest, TCreateRequest, TUpdateRequest, TQuery> service)
            : base(service) {
            _service = service;
        }
        ...
        public virtual async Task<IActionResult> CreateAsync([FromBody] TCreateRequest request) {
            ...
            var result = await _service.GetByIdAsync<TDto>(id);
        ...
        public virtual async Task<IActionResult> UpdateAsync(string id, [FromBody] TUpdateRequest request) {
            ...
            var result = await _service.GetByIdAsync<TDto>(request.Id);
            return Success(result);
        }
