...
namespace ZKCloud.Webs.Controllers {
    ...
    public abstract class QueryControllerBase<TDto, TQuery> : WebApiControllerBase
        ...
        /// 查询服务
        /// </summary>
        private readonly IQueryService<TQuery> _service;

        /// <summary>
        /// 初始化查询控制器
        /// </summary>
        /// <param name="service">查询服务</param>
        protected QueryControllerBase(IQueryService<TQuery> service) {
            _service = service;
        }
        ...
        public virtual async Task<IActionResult> PagerQueryAsync(TQuery query) {
            ...
            var result = await _service.PagerQueryAsync<TDto>(query);
        ...
        public virtual async Task<IActionResult> QueryAsync(TQuery query) {
            QueryBefore(query);
            var result = await _service.QueryAsync<TDto>(query);
