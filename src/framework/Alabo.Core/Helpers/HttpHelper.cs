    ...
    public static class HttpHelper {
        ...
        public static Tuple<ServiceResult, T> Get<T>(string url, string para = null) where T : new() {
            ...
            try {
                ...
                return new Tuple<ServiceResult, T>(ServiceResult.FailedWithMessage($"请求成功，序列化出错,apiUrl:{url}"), default);
            }
        }
        ...
        /// <param name="para"></param>
        /// <returns></returns>
        public static Tuple<ServiceResult, T> Post<T>(string url, object para, Dictionary<string, string> dicHeader = null) where T : new() {
            string response;
            try {
