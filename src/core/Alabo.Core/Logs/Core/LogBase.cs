...
using Alabo.Core.Logs.Extensions;
using Enum = Alabo.Core.Helpers.Enum;
...
namespace Alabo.Core.Logs.Core
{
    ...
    public abstract class LogBase<TContent> : ILog where TContent : class, ILogContent
    {
        ...
        //    Provider = provider;
        //    Context = context;
        //    Session = session ?? Alabo.Domains.Sessions.Session.Null;
        //}
        ...
        protected virtual void Init(TContent content)
        {
            ...
            content.OperationTime = Alabo.Extensions.Extensions.ToMillisecondString(DateTime.Now);
            content.Duration = Alabo.Extensions.Extensions.Description(Context.Stopwatch.Elapsed);
