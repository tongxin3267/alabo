...
namespace Alabo.Data.People.Merchants.Controllers {
		[ApiExceptionFilter]
		[Route("Api/ChainMerchant/[action]")]
		public class ApiChainMerchantController : ApiBaseController<ChainMerchant,ObjectId>  {
 public ApiChainMerchantController() : base() 
	{ 
		BaseService = Resolve<IChainMerchantService>();
	}
