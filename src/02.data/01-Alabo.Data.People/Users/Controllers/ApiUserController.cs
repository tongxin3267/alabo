...
using Alabo.Core.WebUis.Models.Previews;
...
namespace Alabo.App.Core.User.Controllers {
    ...
    public class ApiUserController : ApiBaseController<Users.Entities.User, long> {
        ...
        public ApiUserController(
            ...
            //, Alabo.App.Core.Api.Domain.Service.IApiService apiServer
            BaseService = Resolve<IUserService>();// _ApiServer = apiServer;
        ...
        public ApiResult ChangePassword([FromBody] PasswordInput parameter) {
            ...
            var result = Resolve<IUserDetailService>().ChangePassword(parameter, true);
            if (!result.Succeeded) {
        ...
        public ApiResult<UserOutput> Info(ListInput parameter) {
            ...
            UserOutput userOutput = AutoMapping.SetValue<UserOutput>(user);
        ...
        public ApiResult ConfirmPayPassword([FromBody]ConfirmPayPassword confirmPayPassword) {
            var result = Resolve<IUserDetailService>().ConfirmPayPassword(confirmPayPassword.PayPassWord, confirmPayPassword.LoginUserId);
            return ToResult(result);
        }
