...
using ZKCloud.App.Core.Finance.Domain.Dtos.WithDraw;
using ZKCloud.App.Core.Finance.Domain.Enums;
...
using ZKCloud.UI;
using ZKCloud.UI.AutoForms;
using ZKCloud.UI.AutoTables;
using ZKCloud.Web.Mvc.Attributes;

namespace ZKCloud.App.Core.Finance.UI.AutoForm
{
    ...
    public class WithdrawAdminAutoForm : UIBase, IAutoTable<WithdrawAdminAutoForm>//, IAutoForm
    {
        ...
        /// </summary>
        [Display(Name = "状态")]
        [Field(ControlsType = ControlsType.DropdownList, DataSource = "ZKCloud.App.Core.Finance.Domain.Enums.TradeStatus", ListShow = true, EditShow = false, SortOrder = 4)]
        [Required(ErrorMessage = ErrorMessage.NameNotAllowEmpty)]
        ...
        [Field(ControlsType = ControlsType.DropdownList, ListShow = false, EditShow = false,
            DataSourceType = typeof(Domain.CallBacks.MoneyTypeConfig), IsShowBaseSerach = false,
            SortOrder = 200)]
        ...
        public ZKCloud.UI.AutoForms.AutoForm GetView(object id, AutoBaseModel autoModel)
        {
