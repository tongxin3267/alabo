...
namespace Alabo.Cloud.People.GradeInfos.Domain.Servcies
{
    ...
    {
        public GradeInfoService(IUnitOfWork unitOfWork, IRepository<GradeInfo, ObjectId> repository) : base(unitOfWork,
            repository)
        {
        }
        ...
        public bool GetKpiItemResult(GradeInfo gradeInfo, AutoUpgradeItem autoUpgradeItem)
        {
            ...
            switch (autoUpgradeItem.KpiUpgradeType)
            {
                case KpiUpgradeType.RecommendUser:
                    ...
                    var kpiItemResult =
                        LinqHelper.CompareByOperator(OperatorCompare.GreaterEqual, count, autoUpgradeItem.Count);
        ...
        public IEnumerable<GradeInfoItem> GetUsersGradeInfo(IEnumerable<User> users)
        {
