...
namespace Alabo.Cloud.People.UserTree.Domain.Service {
    ...
    public class UserTreeService : ServiceBase, IUserTreeService {
        ...
        public List<Users.Entities.UserTree> GetTree(long userId, UserTreeConfig userTreeConfig, UserTypeConfig userType, List<UserGradeConfig> userGradeConfigList, UserTypeConfig userServiceConfig) {
