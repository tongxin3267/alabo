...
namespace Alabo.Cloud.People.UserWakeUp.Domain.Dtos {
    ...
    public class ViewOrderUserWakeUp : UIBase, IAutoTable<ViewOrderUserWakeUp> {
        ...
        public PageResult<ViewOrderUserWakeUp> PageTable(object query, AutoBaseModel autoModel) {
            return ToPageResult(new PagedList<ViewOrderUserWakeUp>());
        }
    }
}