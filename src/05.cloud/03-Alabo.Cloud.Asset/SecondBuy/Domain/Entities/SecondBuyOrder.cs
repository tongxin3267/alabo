using Alabo.Cloud.Asset.SecondBuy.Domain.Enums;
...
namespace Alabo.Cloud.Asset.SecondBuy.Domain.Entities
{
    /// <summary>
    ///     订单管理
    /// </summary>
    ...
    public class SecondBuyOrder : AggregateMongodbRoot<SecondBuyOrder>
    {
        ...
        [Display(Name = "详细地址")]
        [Required(ErrorMessage = ErrorMessage.NameNotAllowEmpty)]
        [Field(ControlsType = ControlsType.Label, ListShow = true, IsShowAdvancedSerach = true, EditShow = false,
            SortOrder = 0)]
        ...
        [Display(Name = "商品")]
        [Field(ControlsType = ControlsType.RadioButton, ListShow = true, IsTabSearch = true, EditShow = true,
            SortOrder = 0)]
