...
namespace Alabo.App.Kpis.KpiModules
{
    /// <summary>
    ///     Class UserAssetsModuleBase.
    /// </summary>
    public abstract class KpiBaseModule<TConfiguration> : TaskModuleBase
        where TConfiguration : KpiBaseConfig
    {
        /// <summary>
        ...
        public KpiBaseModule(TaskContext context, TConfiguration configuration)
            : base(context)
        {
