...
using Alabo.App.Share.Rewards.Domain.Repositories;
    ...
    public class RewardService : ServiceBase<Reward, long>, IRewardService
    {
        ...
        public PagedList<ViewHomeReward> GetUserPage(object query)
        {
            ...
            rewardList.ForEach(u =>
            {
                ...
                view.OrderUserName =
                    Resolve<IUserService>().GetHomeUserStyle(users.FirstOrDefault(z => z.Id == u.UserId));
                view.MoneyTypeName = moneyTypes.FirstOrDefault(z => z.Id == u.MoneyTypeId)?.Name;
                result.Add(view);
            });
            return PagedList<ViewHomeReward>.Create(result, rewardList.RecordCount, rewardList.PageSize,
        ...
        public ShareModulesAttribute TryGetModuleAttribute(string id)
        {
            ...
            var moduleTypess = assemblies.SelectMany(e => e.GetTypes())
                .Where(e => e.GetInterfaces().Contains(typeof(IModuleConfig))).ToArray();
        ...
        public IList<ViewShareModuleList> GetViewShareModuleList(HttpContext context, Guid moduleId, string name,
            int? isEnable)
        {
            ...
            foreach (var item in moduleList)
            {
                ...
                radios?.Foreach(r => { viewShare.DistriRatio += $"<span class='m-badge m-badge--focus '>{r}</span>"; });
                ...
                else
                {
                    ...
                    {
                        var grade = Resolve<IGradeService>().GetGradeByUserTypeIdAndGradeId(
                            shareBaseConfig.ShareUser.ShareUserTypeId, shareBaseConfig.ShareUser.ShareUserGradeId);
                ...
                else
                {
                    ...
                    {
                        var grade = Resolve<IGradeService>().GetGradeByUserTypeIdAndGradeId(
                            shareBaseConfig.OrderUser.OrderUserTypeId, shareBaseConfig.OrderUser.OrderUserGradeId);
