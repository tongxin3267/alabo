...
namespace Alabo.App.Share.OpenTasks.Base {
    ...
    public abstract class ShareBaseConfig : BaseViewModel, IModuleConfig {
        ...
        [HelpBlock("需要给N代分润则填写N个比例,以英文符号,分隔开。比如：分润比例设置成0.1 表示一代分润比例为10%；分润比例设置成0.1,0.05  表示一代分润比例为10%,二代为5%；分润比例设置成0.1,0.05,0.03  表示一代分润比例为10%,二代为5%,三代为3%；请根据您的资质，在合法合情范围内设置。设置不能超过三级")]
       ...
       // public ProductShow ProductShow{ get; set; }
        ...
        /// 封顶方式
        /// </summary>
       // public LimitRule LimitRule{ get; set; }
