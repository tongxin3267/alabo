...
namespace Alabo.App.Share.OpenTasks.Configs.TeamRange
{
    ...
    /// </summary>
    [TaskModule("23B9A703-6B42-4915-816F-D1208CC7C00B", "团队级差收益(按比例)", SortOrder = 999999,
        ConfigurationType = typeof(TeamRangeRateConfig), IsSupportMultipleConfiguration = true,
