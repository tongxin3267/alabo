...
namespace Alabo.App.Share.OpenTasks.Configs.TeamRange
{
    ...
    public class TeamFiexdAchievementRangConfig : ShareBaseConfig
    {
        ...
        [Field(ControlsType = ControlsType.Json, PlaceHolder = "请按会员等级升级点值的权重来设置，原则上等级越高，比例越高", ListShow = false,
            EditShow = true, ExtensionJson = "TeamFiexdAchievementRangItems")]
        [JsonIgnore]
        [Display(Name = "团队极差")]
        ...
        /// </summary>
        public IList<TeamFiexdAchievementRangItem> TeamFiexdAchievementRangItems { get; set; } =
            new List<TeamFiexdAchievementRangItem>();
    ...
    /// </summary>
    [TaskModule("23B9A703-6B42-4915-810F-01208CC0C000", "岗位绩效收益(按固定金额)", SortOrder = 999999,
        ConfigurationType = typeof(TeamFiexdAchievementRangConfig), IsSupportMultipleConfiguration = true,
        FenRunResultType = FenRunResultType.Price,
        Intro =
            "不同岗位间的最高提成比例会有所不同，岗位低的会员不能拿完所有的绩效，多余的部分给岗位高的。比如公司有业务员、经理、总监三个岗位，直接销售一个订单，最高奖金分别为100,200,300。如果是业务员A成单，业务员A奖金100，经理奖金100,总监奖金100。如果是经理B成单，业务员A奖金0，经理B奖金200,总监C奖金100。如果是总监C成单，业务员A奖金0，经理B奖金0,总监C奖金300。",
    ...
    public class TeamFiexdAchievementRangItem
    {
        ...
        [Field(ControlsType = ControlsType.DropdownList, ListShow = true, EditShow = true,
            DataSource = "UserGradeConfig", SortOrder = 1)]
        [Display(Name = "等级权重")]
