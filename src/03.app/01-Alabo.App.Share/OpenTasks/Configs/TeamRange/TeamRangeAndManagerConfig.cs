...
namespace Alabo.App.Share.OpenTasks.Configs.TeamRange
{
    ...
    public class TeamRangeAndManagerConfig : ShareBaseConfig
    {
        ...
        /// </summary>
        public IList<TeamRangeAndManagerConfigItem> TeamRangeRateItems { get; set; } =
            new List<TeamRangeAndManagerConfigItem>();
    ...
    /// </summary>
    [TaskModule("23B9A703-6B42-4025-816F-D1208CC0C00a", "级差与管理收益(按比例)", SortOrder = 999999,
        ConfigurationType = typeof(TeamRangeAndManagerConfig), IsSupportMultipleConfiguration = true,
        FenRunResultType = FenRunResultType.Price, IsSupportSetDistriRatio = false,
        Intro =
            "推荐人可拿到极差收益,不同的等级之间提成比例会有所不同，比如总监A的提成比例为30%，经理B的提成比例为20%,业务员的提成比例为10%。那么经理可以拿到业务员的级差为10%，总监可以拿到经理的级差为10%，业务员的级差为20%",
