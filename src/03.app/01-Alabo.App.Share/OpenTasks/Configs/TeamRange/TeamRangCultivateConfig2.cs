...
namespace Alabo.App.Share.OpenTasks.Configs.TeamRange
{
    ...
    public class TeamRangCultivateConfig2 : ShareBaseConfig
    {
        ...
        ///     团队极差
        /// </summary>
        [Field(ControlsType = ControlsType.Json, PlaceHolder = "请按会员等级升级点值的权重来设置，原则上等级越高，比例越高,等级配置不能重复",
            ListShow = false, EditShow = true, ExtensionJson = "TeamRangCultivateItems")]
