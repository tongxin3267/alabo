...
namespace Alabo.Framework.Core.Enums.Enum
{
    ...
    public enum AddressLockType
    {
        ...
        /// </summary>
        [Display(Name = "收货地址")] [LabelCssClass(BadgeColorCalss.Success)]
        OrderAddress = 1,
        ...
        /// </summary>
        [Display(Name = "备案地址")] [LabelCssClass(BadgeColorCalss.Warning)]
        UserInfoAddress = 2,

        /// <summary>
        ///     发货人的注册地址
        /// </summary>
        [Display(Name = "发货地址")] [LabelCssClass(BadgeColorCalss.Warning)]
        DeliveryUserAddress = 3,

        /// <summary>
        ///     自定义商城订单地址
        /// </summary>
        [Display(Name = "自定义商城订单地址")] [LabelCssClass(BadgeColorCalss.Warning)]
