...
namespace Alabo.Framework.Tasks.Schedules.Domain.Enums
{
    ...
    public enum FenRunResultType
    {
        ...
        /// </summary>
        [LabelCssClass(BadgeColorCalss.Success)] [Display(Name = "价格分润")]
        Price = 1,

        /// <summary>
        ///     队列方式执行
        /// </summary>
        [LabelCssClass(BadgeColorCalss.Success)] [Display(Name = "队列方式执行")]
        Queue = 2,

        /// <summary>
        ///     更新业绩
        /// </summary>
        [LabelCssClass(BadgeColorCalss.Success)] [Display(Name = "更新业绩")]
        Sales = 3
    }
}