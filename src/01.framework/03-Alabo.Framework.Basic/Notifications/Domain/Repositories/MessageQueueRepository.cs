...
namespace Alabo.Framework.Basic.Notifications.Domain.Repositories
{
    public class MessageQueueRepository : RepositoryEfCore<MessageQueue, long>, IMessageQueueRepository
    {
        ...
        public void Add(MessageQueue entity)
        {
            ...
            if (entity.Message == null) entity.Message = string.Empty;

            if (entity.Summary == null) entity.Summary = string.Empty;

            if (entity.Parameters == null) entity.Parameters = string.Empty;
            ...
            if (result != null && result != DBNull.Value) entity.Id = Convert.ToInt64(result);
        }
        ...
        public MessageQueue GetSingle(long id)
        {
            ...
            {
                if (dr.Read()) result = ReadQueue(dr);
            }
