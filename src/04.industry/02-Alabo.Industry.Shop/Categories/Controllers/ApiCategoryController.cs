...
namespace Alabo.Industry.Shop.Categories.Controllers
{
    ...
    public class ApiCategoryController : ApiBaseController<Category, Guid>
    {
        ...
        [HttpGet]
        public ApiResult<Category> ProductProperty(string categoryId)
        {
            ...
            var dispList = category.DisplayPropertys.OrderBy(s => s.SortOrder).Select(
                x => new ViewDisplayProperty
                {
                    ...
                    ControlsType = (ViewPropertyControlsType) Enum.ToObject(typeof(ViewPropertyControlsType),
                        (int) x.ControlsType),
                    Values = x.PropertyValues.Select(y => new ViewPropertyValue {Id = y.Id, ValueName = y.ValueName})
                        .ToList(),
        ...
        private CategoryProperty ProcessDispProp(Category catetory, ViewDisplayProperty dispProp)
        {
        ...
        private CategoryProperty ProcessProp(Category catetory, ViewSaleProperty saleProp)
        {
            CategoryProperty property;
