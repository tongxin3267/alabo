...
namespace Alabo.App.Shop.Coupons.Domain.Entities
{
    ...
    Width = "150", ListShow = true, EditShow = true, SortOrder = 2)]
        ...
        [Field(ControlsType = ControlsType.DataSelect, DataSource = "Alabo.App.Shop.Coupons.Domain.Enums.CouponStatus", IsShowBaseSerach = false, IsShowAdvancedSerach = false,
