...
namespace Alabo.App.Shop.Activitys.Modules.TimeLimitBuy.Model
{
    ...
    public class TimeLimitBuyActivity : BaseViewModel, IActivity
    {
        ...
        /// 预售开始时间
        /// </summary>
        [Display(Name = "开始时间"), Field(ControlsType = ControlsType.DateTimePicker, ListShow = true, EditShow = true)]
        ...
        /// 预售结束时间
        /// </summary>
        [Display(Name = "结束时间"), Field(ControlsType = ControlsType.DateTimePicker, ListShow = true, EditShow = true)]
