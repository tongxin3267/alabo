...
namespace Alabo.App.Shop.Product.Domain.Services
{
    ...
    public class ProductSkuService : ServiceBase<ProductSku, long>, IProductSkuService
    {
        ...
        public ServiceResult AddUpdateOrDelete(Entities.Product product, List<ProductSku> skuList)
        {
        ...
        public ProductSkuService(IUnitOfWork unitOfWork, IRepository<ProductSku, long> repository) : base(unitOfWork, repository)
        {
